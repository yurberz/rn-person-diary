...
import {View, Platform, KeyboardAvoidingView, TextInput, Button, ScrollView} from 'react-native';
import {HomeStackProps} from '../../../../helpers/ts-helpers/types';
// import {useAppDispatch} from '../../../../hooks/reduxHooks';
// import { updateEntry, deleteEntry } from '../../../../redux/reducers/diaryReducer';
...
const NoteScreen = ({navigation, route}: HomeStackProps) => {
  ...
  useEffect(() => {
    navigation.setOptions({
      ...
      headerRight: () => { return !isInEditMode ? (
        <>
          <IconButton
          onPress={() => {
  ...
  return (
    ...
    <View style={styles.containerStyle}>
      <KeyboardAvoidingView
        ...
        {isInEditMode && (<View style={styles.featuresBarStyles} >
          <IconButton
          onPress={() => setIsDateModal(true)}
          iconName="ios-calendar"
          iconSize={30}
